...
public abstract class AbsHomescreenActivity extends AppCompatActivity implements HomescreenView {
  ...
  private HomescreenPresenter presenter;
    ...
    presenter = new HomescreenPresenterImpl(this, getRestClientConfig());
  ...
  public Context getContext() {
	...
	private ActionBarDrawerToggle getActionBarDrawerToggle(Toolbar toolbar, int stringId) {
		userLearnedDrawer = PreferenceManager.getDefaultSharedPreferences(AbsHomescreenActivity.this).getBoolean(PREF_USER_LEARNED_DRAWER, false);
		...
		ActionBarDrawerToggle drawerToggle = new ActionBarDrawerToggle(
			...
			public void onDrawerOpened(View drawerView) {
				...
				if (!userLearnedDrawer) {
					...
					SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(AbsHomescreenActivity.this);
