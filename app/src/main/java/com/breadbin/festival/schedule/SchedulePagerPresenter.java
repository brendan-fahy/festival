...
public class SchedulePagerPresenter {

  private SchedulePagerWidget widget;

  private Schedule schedule;

  public SchedulePagerPresenter(SchedulePagerWidget widget, Schedule schedule) {
    this.widget = widget;
    this.schedule = schedule;
  }

  public void onStart() {
    PagerAdapter adapter = new ListPagerAdapter(schedule);
    widget.setupViewPager(adapter);
    widget.setupTabLayout(adapter);
    widget.setupTitle();
  }
  ...
  private class ListPagerAdapter extends PagerAdapter {
    ...
    public ListPagerAdapter(Schedule schedule) {
      this.schedule = schedule;
    }
  ...
  private class EventsAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
      if (convertView == null) {
        convertView = EventCard.build(widget.getContext());
      }
